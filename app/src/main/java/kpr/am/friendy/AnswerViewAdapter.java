 ...
 */
public class AnswerViewAdapter extends RecyclerView.Adapter<AnswerMyViewHolder> {
    ...
    public AnswerViewAdapter(Context c, ArrayList<QuestionBank> questionBanks) {
        this.c = c;
    ...
    private void addDataToFirestore(String ques, String phone, String s, String funny, String ans, int po, Button savbtn, String frdnum) {
        ...
        CollectionReference dbCourses = db.collection("kpr.am.friendy.Answers.Requests");
